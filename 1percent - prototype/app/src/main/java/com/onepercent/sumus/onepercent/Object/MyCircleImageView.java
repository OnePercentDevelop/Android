...
public class MyCircleImageView extends ImageView {
    ...
    public MyCircleImageView(final Context context) {
        this(context, null);
    }
    ...
    public MyCircleImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
